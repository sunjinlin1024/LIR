#ifndef __LIR_FILEUTILS_H__
#define __LIR_FILEUTILS_H__
...
public:
	...
	*/
	virtual Buffer getDataFromFile(const std::string& filename);
	...
	*/
	...
	//}
	virtual FileStatus getContents(const std::string& filename, Buffer* buffer);
	...
	*/
	virtual std::string getWritablePath() const; //todo = 0;
	...
	*@return bool
	*/
	virtual bool writeDataToFile(const Buffer& data, const std::string& fullPath);
...
protected:
	...
	*/
	virtual bool isFileExistInternal(const std::string& filename) const;//todo = 0;
