...
class LIR_DLL FileUtilsWin32 : public FileUtils
{
...
protected:
    ...
    */
	...
	virtual FileStatus getContents(const std::string& filename, Buffer* buffer) override;
...
#endif    // __LIR_FILEUTILS_WIN32_H__
