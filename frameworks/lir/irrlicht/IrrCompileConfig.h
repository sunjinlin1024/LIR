...
//! Define __IRR_COMPILE_WITH_LPQ_ARCHIVE_LOADER_ if you want to open LPQ archives
#define __IRR_COMPILE_WITH_LPQ_ARCHIVE_LOADER_
#ifdef NO__IRR_COMPILE_WITH_LPQ_ARCHIVE_LOADER_
#undef __IRR_COMPILE_WITH_LPQ_ARCHIVE_LOADER_
#endif
